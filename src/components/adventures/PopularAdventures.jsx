...
export default function PopularAdventures() {
  ...
  return (
    <section className="w-full bg-[#551DEF] py-16">
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
          {adventures.map((img, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl overflow-hidden shadow-md max-w-[260px] mx-auto"
            >
              {/* Image */}
              ...
              <div className="p-4">
                ...
                <p className="mt-3 text-sm text-gray-800">
                  Starting from{" "}
                  <span className="font-bold text-[#5B27FF] text-md">
                    ₹8999.00
                  </span>
                </p>
              </div>
